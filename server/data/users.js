const users = [
  {
    name: 'Orient Store Administrator',
    ...
    address: {
      division: 'Dhaka',
      district: 'Dhaka',
      street: 'Orient Engineering Center, Motijheel C/A',
      postalCode: '1000',
      country: 'Bangladesh',
    },
  ...
  {
    name: 'Orient Store Administrator',
    email: 'admin@orient.com.bd',
    password: 'orient123456',
    role: 'admin',
    phone: '+8801711000002',
    address: {
      division: 'Dhaka',
  ...
  {
    name: 'Fahim Shahriar',
    email: 'customer@orientcomputers.com.bd',
    ...
    address: {
      division: 'Dhaka',
      district: 'Dhaka',
      street: 'House 42, Road 11, Dhanmondi',
      postalCode: '1209',
      country: 'Bangladesh',
    },
