...
export default function OrderSuccessPage() {
  ...
  if (!order) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-16 text-center space-y-4">
        ...
        <Link to="/" className="inline-block px-6 py-2.5 bg-blue-600 hover:bg-blue-500 text-white font-semibold text-xs rounded-xl shadow-sm transition-colors">
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 space-y-8">
      ...
      <div className="rounded-3xl bg-[#0F172A] border border-slate-800 p-8 text-center space-y-4 shadow-sm print:hidden">
        <div className="h-16 w-16 rounded-full bg-emerald-500/20 border border-emerald-500/40 text-emerald-400 flex items-center justify-center mx-auto shadow-sm">
      ...
      <div className="rounded-3xl bg-[#0F172A] border border-slate-800 p-8 sm:p-12 space-y-8 shadow-sm text-slate-200 print:bg-white print:text-black print:p-0 print:border-none print:shadow-none">
        {/* Invoice Header */}
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center pb-6 border-b border-slate-800 print:border-slate-300 gap-4">
          <div>
            ...
            <span className="text-[11px] font-semibold uppercase tracking-wider text-slate-400 ml-1.5 px-2 py-0.5 rounded bg-slate-800 border border-slate-700 print:border-black print:text-black">
          ...
          <div className="text-right sm:text-right space-y-1">
            <div className="text-xs uppercase font-bold text-blue-400 print:text-black">TAX INVOICE</div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 p-5 rounded-2xl bg-slate-900/90 border border-slate-800 print:bg-gray-100 print:border-gray-300 text-xs">
          <div>
            ...
            <div className="font-mono font-semibold text-blue-400 print:text-black text-sm">
            ...
            <tbody className="divide-y divide-slate-800 print:divide-gray-300">
              {order.orderItems?.map((item, idx) => (
                <tr key={idx}>
                  ...
                  <td className="py-3 px-2 text-right font-extrabold text-white print:text-black">
        ...
        <div className="flex justify-end pt-4 border-t border-slate-800 print:border-gray-300">
          <div className="w-full sm:w-72 space-y-2 text-xs">
            ...
            <div className="flex justify-between text-base font-bold pt-2 border-t border-slate-800 print:border-gray-300 text-white print:text-black">
              ...
              <span className="font-extrabold text-white print:text-black">{formatPrice(order.totalPrice)}</span>
            </div>
          </div>
        </div>
