  ...
  if (cartItems.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center space-y-6">
        ...
        <Link
          to="/shop"
          className="inline-flex items-center space-x-2 px-6 py-3.5 rounded-xl bg-cyan-600 hover:bg-cyan-500 text-white font-bold text-xs shadow-lg shadow-cyan-600/25 transition-all"
        >
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 space-y-4">
          <div className="rounded-2xl bg-[#0F172A] border border-slate-800 overflow-hidden shadow-xl divide-y divide-slate-800">
            {cartItems.map((item) => (
                ...
                <div className="flex items-center space-x-4 flex-1 min-w-0">
                  ...
                  <div className="space-y-1 min-w-0">
                    ...
                    <Link
                      ...
                      className="block text-sm font-heading font-bold text-white hover:text-cyan-400 transition-colors line-clamp-2"
                    >
                      {item.title}
                    </Link>
            ...
            {appliedCoupon ? (
              ...
              <form onSubmit={handleApplyCoupon} className="flex flex-col sm:flex-row gap-2">
                <input
                  ...
                  className="flex-1 bg-slate-900 border border-slate-700 rounded-xl px-4 py-2.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-cyan-500 uppercase font-mono"
                />
                <button
                  type="submit"
                  className="px-6 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-700 text-cyan-400 font-bold text-xs transition-colors"
                >
                  Apply Voucher
                </button>
              </form>
        ...
        <div className="lg:col-span-4 rounded-2xl bg-[#0F172A] border border-slate-800 p-6 space-y-5 shadow-2xl sticky top-28">
          ...
          <button
            ...
            className="w-full py-3.5 rounded-xl bg-gradient-to-r from-orange-500 via-amber-500 to-orange-600 hover:from-orange-400 hover:to-amber-400 text-white font-bold text-sm shadow-xl shadow-orange-500/25 flex items-center justify-center space-x-2 transition-all transform active:scale-[0.98]"
          >
