      ...
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex flex-wrap items-center gap-4 sm:gap-6">
          ...
          <a
            ...
            className="hidden md:inline-flex items-center space-x-1.5 hover:text-cyan-400 transition-colors"
          >
        ...
        <div className="flex items-center space-x-4 sm:space-x-6 ml-auto">
          ...
          <Link
            to="/track-order"
            className="inline-flex items-center space-x-1.5 text-orange-400 hover:text-orange-300 font-medium transition-colors"
          >
